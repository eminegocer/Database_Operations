...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<EmployeePerforman> EmployeePerformans { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=northwind;user=root;password=mysql1234", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.37-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeePerforman>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("employee_performans");
            ...
            entity.Property(e => e.SatisAdedi).HasColumnName("satis_adedi");
        });
